use bamboo_mcp::McpClient;
use bamboo_core::tools::{ToolExecutor, ToolCall, FunctionCall};
...
async fn main() {
    ...
    let call = ToolCall {
        ...
        function: FunctionCall {
            ...
            arguments: r#"{"path": "/tmp/bamboo_test.txt", "content": "Hello from Copilot Agent!"}"#.to_string(),
        },
    };
    ...
    let call = ToolCall {
        ...
        function: FunctionCall {
            ...
            arguments: r#"{"path": "/tmp/bamboo_test.txt"}"#.to_string(),
        },
    };
