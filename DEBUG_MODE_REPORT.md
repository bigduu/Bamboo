...
**文件**: `bamboo-server/src/logging.rs` (新建)
...
**文件**: `bamboo-server/src/agent_runner.rs`
...
**文件**: `bamboo-server/src/handlers/stream.rs`
...
1. ✅ `bamboo-server/src/logging.rs` (新建)
2. ✅ `bamboo-server/src/main.rs` (添加 debug flag)
3. ✅ `bamboo-server/src/agent_runner.rs` (添加 debug 日志)
4. ✅ `bamboo-server/src/handlers/stream.rs` (添加 SSE debug)
5. ✅ `bamboo-server/Cargo.toml` (添加 chrono, clap)
6. ✅ `bamboo-cli/src/main.rs` (添加 --debug flag)
